...
export default function SellerDashboardPage() {
  ...
  return <DashboardShell role="Seller" title="Seller overview" description={profile ? `Welcome, ${profile.shop_name}. Manage your listings and orders.` : 'Manage your listings and keep an eye on your sales.'} nav={[{ label: 'Overview', to: '/dashboard/seller' }, { label: 'Messages', to: '/messages' }, { label: 'Notifications', to: '/notifications' }, { label: 'Marketplace', to: '/marketplace' }]} metrics={metrics}>
